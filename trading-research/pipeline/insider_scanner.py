...
Provides:
  - InsiderTransaction and InsiderCluster dataclasses
  - Shared filter constants (cluster window, minimum sizes, qualifying roles)
  - classify_routine() helper implementing Cohen-Malloy-Pomorski (2012, JF)
...
CLUSTER_WINDOW_DAYS = 30        # academic studies use 1-3 month windows
